...
import { SCard, SCardList, SCardTitle, SInput, STableWrapper } from './_styled';
						...
						<div className="status-list-wrapper">
							<ul>
								...
								<li>
									...
									<span className="content" style={{ width: '160px' }}>
										{states.operationCoolDown}
									</span>
								</li>
								<li>
									<span className="title">{CST.TH_LAST_OPT_TIME}</span>
									<span className="content" style={{ width: '160px' }}>
										{states.lastOperationTime}
									</span>
								</li>
								<li>
									...
									<SInput
										...
										disabled={
											account.toLowerCase() !== operator.address.toLowerCase()
										}
										width={'300px'}
										onChange={e =>
