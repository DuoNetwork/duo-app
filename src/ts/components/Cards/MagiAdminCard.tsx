				...
				<SCardList>
					<div className="status-list-wrapper">
						<ul>
							...
							<li>
								<span className="title">{CST.TH_PRICE_FEED_COOL_DOWN[locale]}</span>
								<span className="content">
							...
							<li>
								<span className="title">{CST.TH_PRICE_FEED_TOLERANCE[locale]}</span>
								<span className="content">
							...
							<li>
								...
								<span className="content">{states.priceTolerance * 100 + '%'}</span>
							</li>
						</ul>
					</div>
				</SCardList>
						...
						<ul>
							{addresses.map((address, i) => (
								<li className="block-title">
									<span className="title">{CST.TH_PRICE_FEED[locale] + i}</span>
							...
							<li className="no-bg">
								...
								>
									...
									<SInput
										...
										width={'400px'}
										onChange={e => this.handleRoleManagerChange(e.target.value)}
										small
									/>
									<button
										className={'form-button'}
							...
							<li className="no-bg">
								...
								>
									...
									<SInput
										...
										placeholder={CST.TT_INPUT_INDEX[locale]}
										width={'100px'}
										onChange={e => this.handleSetValueIdxChange(e.target.value)}
										small
									/>
									<SInput
										className={roleManagerErr ? 'input-error' : ''}
										...
										width={'300px'}
										onChange={e => this.handleSetValueChange(e.target.value)}
										small
									/>
									<button
										className={'form-button'}
