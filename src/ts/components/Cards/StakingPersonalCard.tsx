...
import { SCard, SCardTag2, SCardTitle } from './_styled';
	...
	public render() {
		...
		return (
			<SCard title={<SCardTitle>DUO Staking</SCardTitle>} width="960px" margin="0 0 20px 0">
				<div style={{marginTop: 15}}><img style={{width: 16, height: 16, marginRight: 10, marginLeft: 5}}src={avt}/>My address: <span style={{color: '#5CA4DE'}}>{address}</span></div>
				<img style={{position: "absolute", right: 15, bottom: 10, height: 100, width: 240}} src={duo3d}/>
				<SCardTag2 style={{pointerEvents: 'none'}}>
					<div className="bg-logo">
						<img src={duoIcon} />
					</div>
					<div className="tag-content">
						<div className={'tag-price USD'} style={{fontSize: 12}}>DUO Balance</div>
					</div>
